...
public class CameraUtils {
    ...
    public static void switchFlashLight(int cameraID,boolean lightStatus){
        if(mCamera!=null && mCamera.getParameters()!=null){
            Camera.Parameters parameters = mCamera.getParameters();
            Log.d(TAG, "switchFlashLight: "+lightStatus);
            parameters.setFlashMode(lightStatus?parameters.FLASH_MODE_TORCH:parameters.FLASH_MODE_OFF);
            mCamera.setParameters(parameters);
        }
    }
    ...
    public static void setPictureSize(Camera camera, int expectWidth, int expectHeight) {
        ...
        Camera.Size size = calculatePerfectSize(parameters.getSupportedPictureSizes(),
                expectWidth, expectHeight);
        Log.d(TAG, "setPictureSize: "+expectWidth);
        Log.d(TAG, "setPictureSize: "+expectHeight);
